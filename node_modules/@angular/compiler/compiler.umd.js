    ...
    */
    ...
    var CompilePipe = (function () {
        function CompilePipe(view, name) {
            ...
            this.instance = THIS_EXPR.prop("_pipe_" + name + "_" + view.pipeCount++);
        }
        ...
        CompilePipe.prototype.create = function () {
            ...
            this._purePipeProxies.forEach(function (purePipeProxy) {
                createPureProxy(_this.instance.prop('transform').callMethod(BuiltinMethod.bind, [_this.instance]), purePipeProxy.argCount, purePipeProxy.instance, _this.view);
            });
        };
        CompilePipe.prototype.call = function (callingView, args) {
            if (this.meta.pure) {
                var purePipeProxy = new _PurePipeProxy(THIS_EXPR.prop(this.instance.name + "_" + this._purePipeProxies.length), args.length);
                this._purePipeProxies.push(purePipeProxy);
                return getPropertyInView(importExpr(Identifiers.castByValue)
